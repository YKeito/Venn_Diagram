...
union(CY15_1h_FDR0005, CY15_3h_FDR0005)
#CY16_time
...
####write.table####
write.table(CY15_FDR0005_time, "~/Nakano_RNAseq/PCC/new/Venn Diagram/CY15_FDR0005_time.txt", append=F, quote = F, sep = "\t", row.names = F)
write.table(CY16_FDR0005_time, "~/Nakano_RNAseq/PCC/new/Venn Diagram/CY16_FDR0005_time.txt", append=F, quote = F, sep = "\t", row.names = F)
write.table(CY20_FDR0005_time, "~/Nakano_RNAseq/PCC/new/Venn Diagram/CY20_FDR0005_time.txt", append=F, quote = F, sep = "\t", row.names = F)
